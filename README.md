# CHANPUNK
Chanpunk is a fork of [Coinpunk](https://coinpunk.com/) modified for use on the [Chancoin](http://chancoin.org) network. 

## Notice: Use at your own risk.

Chanpunk is experimental beta software based on beta software upstream. Be Forewarned. Use at your own risk.

## Who uses Chanpunk

Like Coinpunk, Chanpunk is aimed at developers, power users, and sysadmins interested in running their own web-based Chancoin wallet.

Chanpunk is also used to power the open source web-based Chancoin wallet service at [vtc.li](http://vtc.li).

## Get Started

Chanpunk requires the [chancoin-watchony](https://github.com/dayreiner/chancoin-watchonly) version of chancoind to function.

See the [Install Guide](docs/INSTALL.md)

## Chanpunk is for Advanced Users

Like Coinpunk, Chancoin is also intended for advanced users only. Kyle says it best:
...
Chanpunk would not be possible without Coinpunk. Please see [below](#help) to see how you can help with the upstream project. 
